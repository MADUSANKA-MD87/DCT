...
const BOT_NAME_FANCY = '∂¢т ησνα χ м∂';
...
const config = {
  ...
  GROUP_INVITE_LINK: 'https://chat.whatsapp.com/BoPr3fqYBse39S1mgs9oKx',
  RCD_IMAGE_PATH: 'https://i.ibb.co/1Jfjy50k/38df2cbff83a.jpg',
  NEWSLETTER_JID: [
      '120363423916773660@newsletter'],
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(',') : ['94779357798','94752978237'],
  ...
  IMAGE_PATH: 'https://i.ibb.co/1Jfjy50k/38df2cbff83a.jpg',
  BOT_FOOTER: '> *© ∂¢т ησνα χ м∂*',
...
const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://dct-dula:pName=dctninja';
...
✨ ∂¢т ησνα χ м∂ 𝗦𝘆𝘀𝘁𝗲𝗺 𝗶𝘀 𝗻𝗼𝘄 𝗼𝗻𝗹𝗶𝗻𝗲 & 𝗿𝗲𝗮𝗱𝘆!`,
  useBotName
);
...
`;
  ...
  try {
    ...
    const title = userCfg.botName || '∂¢т ησνα χ м∂';
...
`.trim();
    ...
    const defaultImg = 'https://i.ibb.co/1Jfjy50k/38df2cbff83a.jpg';
  ...
  break;
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '© ∂¢т ησνα χ м∂ ||🍃'; // dynamic bot name
...
`
    ...
    break;
          ...
          try {
            ...
            const botName = cfg.botName || "∂¢т ησνα χ м∂";
            const logo = cfg.logo || config.RCD_IMAGE_PATH;
...
case 'csong': {
    try {
        ...
        try {
            ...
            const _0x6368616d61 = "Powered by ∂¢т ησνα χ м∂"; 
...
case 'alive': {
        ...
        case 'owner': {
          ...
          // ✅ BOT NAME
          const BOT_NAME = "∂¢т ησνα χ м∂";

          // ✅ OWNER DETAILS
          const ownerName = "∂¢т ησνα χ м∂";
...
case 'song': {
  ...
  try {
    ...
    const caption = `*© ∂¢т ησνα χ м∂ 𝗦ᴏɴɢ 𝗗ᴏᴡɴʟᴏᴀᴅᴇʀ*
